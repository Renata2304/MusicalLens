...
class WarmUpLearningRate(tf.keras.optimizers.schedules.LearningRateSchedule):
    def __init__(self, init_lr=0.001, warm_up_steps=1000, decay_step=3000, decay_rate=0.25, min_lr=1e-8):
...
if __name__ == "__main__":
    ...
    dataset_path = "G:/LICENTA/ds2_dense"

    manual_th = None

    model_path = "seg_unet" 
    f_name = "G:/LICENTA/Licenta/Licenta/OMR/NOU TOT/image.png"
